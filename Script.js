...
function finalizarCompra() {
    ...
    alert(
        "Gracias por tu compra en Berry Bliss. " +
...
function enviarMensaje() {
    ...
    let respuesta =
        "Gracias por escribirnos. Un asesor de Berry Bliss puede ayudarte.";
    ...
    if (
        ...
        respuesta =
            "Tenemos fresas con toppings, con bañadas en chocolate, bañadas en crema, Caja berry bliss supreme y otros productos.";
        ...
        respuesta =
            "Nuestro horario es de lunes a sábado de 9:00 AM a 6:00 PM.";
